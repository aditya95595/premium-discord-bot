...
export type GuildSettingsRow = {
  ...
  security_enabled: number; security_action: string; security_threshold: number; security_window_seconds: number; security_trusted_users: string;
  coc_clan_tag: string;
};
...
const allowed = new Set<keyof GuildSettingsRow>(['prefix','automod_enabled','automod_profanity','automod_caps','automod_links','automod_spam_threshold','automod_mention_limit','automod_invites','automod_blocked_words','automod_punishment','mod_log_channel','staff_roles','raid_mode','raid_threshold','raid_window_seconds','status_rotation_enabled','status_rotation_interval','security_enabled','security_action','security_threshold','security_window_seconds','security_trusted_users','coc_clan_tag']);
